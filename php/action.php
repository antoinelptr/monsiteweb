...
if($responseKeys["success"]) {
    ...
    function sendMail(string $to, string $from, string $from_name, string $subject, string $body) {
        ...
        $mail->Username = $CONFIG['test@sts-sio-caen.info'];
        $mail->Password = $CONFIG['00000000'];
...
// !!! ENVOI DU MESSAGE !!! //
    try{
        sendMail('pjean12345.12345@gmail.com', 'me@gmail.com', $_POST['nomprenom'], 'Test', '<h1>Test</h1><p>Message</p>');
